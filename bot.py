    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("BotsList Channel", url="https://t.me/martinbot12")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Bots Channel", url="https://t.me/martinbot12"),
    ...
    if "aboutbot" in cb_data:
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/mybotsupport).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
